...
const RegisterPage = () => {
    ...
    setLoading(true);
    try{
      await authService.register(username,email,password);  //authService.register() backend API call karta hai...Agar email/password sahi hai to backend reply karega:
      
      toast.success('Registration is successfull! Please Login.')
      navigate('/login');
    }catch(err){
          ...
          <div className='relative w-full max-w-md px-6'>
            <div  className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
              ...
              <div className='text-center mb-10'>
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-teal-600 to-cyan-500 shadow-lg shadow-emerald-500/25 mb-6">
               ...
               {/* Footer */}
                           <div className='mt-8 pt-6 border-slate-200/60'>
                             <p className='text-center text-sm text-slate-600'>
                               ...
                               <Link to='/login' className='font-semibold text-cyan-600 hover:text-cyan-700 transition-colors duration-200'>
                               Sign in
                               </Link>
                             </p>
                           </div>
