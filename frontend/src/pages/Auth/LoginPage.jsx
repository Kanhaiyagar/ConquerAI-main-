...
const LoginPage = () => {
  ...
  return (
      <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50'>
       ...
       <div className='absolute inset-0 bg-[radial-gradient(#eSe7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30'/>

        <div className='relative w-full max-w-md px-6'>
          <div  className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
            {/* Header */}
            <div className='text-center mb-10'>
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-teal-600 to-cyan-500 shadow-md shadow-emerald-500/20">
              ...
              <div className='space-y-2'>
                ...
                <div className='relative group'>
                   ...
                   <input
                     ...
                     onBlur={()=>setFocusedField(null)}
                     className='w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placehoder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10'
                     placeholder='........'
                     />
                </div>
              </div>
            ...
            <div className='mt-8 pt-6 border-slate-200/60'>
              <p className='text-center text-sm text-slate-600'>
                ...
                <Link to='/register' className='font-semibold text-cyan-600 hover:text-cyan-700 transition-colors duration-200'>
                Sign up
                </Link>
              </p>
            </div>
             ...
             <p className='text-center text-xs text-slate-400 mt-6'>
              By continuing, you agreee to our Terms & Privacy Policy
             </p>
        </div>
      </div>
  )
