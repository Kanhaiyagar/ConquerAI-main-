...
const QuizResultPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto'>
      ...
      {/* Score */}
      <div className='bg-white/80 backdrop-blur-xl border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8'>
      ...
      <div className='space-y-6'>
        <div className='flex items-center gap-3 mb-2'>
          ...
          <h3 className='text-lg font-semibold text-slate-900' >Detailed Page</h3>
        </div>
                ...
                <div className='flex items-start justify-between gap-4 mb-3'>
                  <div className='flex-1'>
                    ...
                    isCorrect
                      ...
                      {isCorrect ? (
                        <CheckCircle2 className='w-5 h-5 text-emerald' strokeWidth={2.5} />
                      ):(
                  ...
                  {result.explanation && (
                    <div className='p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl'>
                      <div className='flex items-start gap-3'>
                        ...
                        <div className='flex-1'>
                          <p className='text-xs font-semibold text-slate-600 uppercse tracking-wide mb-1'>
                            Explanation
                          </p>
      ...
      <div className='mt-8 flex justify-center'>
        ...
        <button className='group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden'>
          ...
          <div className='absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:transition-x-full transition-transform duration-700'/>
        </button>
        </Link>
      </div>
    </div>
