...
const DocumentListPage = () => {
  ...
  //State for upload modal   isUploadModalOpen = true  =>Upload form/modal visible  and vice versa
        ...
        <div className='flex items-center justify-center min-h-[400px]'>
          <div className='text-center max-w-md'>
            <div className='inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-linear-to-br from-slate-100 to-slate-200 shadow-lg shadow-slate-200/50 mb-6'>
              <FileText
                className='w-10 h-10 texte-slate-400'
                strokeWidth={1.5}
                />
            </div>
            ...
            <button 
               ...
               className='inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 active:scale-[0.98]'
               >
                 ...
                 <form onSubmit={handleUpload} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full h-12 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
                  ...
                  <div className="space-y-2">   
                    ...
                    <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                      <input
                        ...
                        onChange={handleFileChange}  //it means yha hum kewal file select krenge ki konsi file submit krni hai
                        accept='.pdf'  //Sirf PDF file allowed
                        />
                  ...
                  <div className='flex gap-3 pt-2'>
                    <button 
                      type="button"
                      onClick={()=> setIsUploadModalOpen(false)}
                      disabled={uploading}   //uploading cancel krta hai
                ...
                <button
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      onClick={()=>setIsDeleteModalOpen(false)}
                      disabled={deleting}
                      className="flex-1 h-11 border-2 border-slate-200 rounded-xl bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Cancel
                      </button>
