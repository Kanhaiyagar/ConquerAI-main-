      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='mb-6'>
          ...
          <p className='text-slate-500 text-sm'>
            Track your learning and activity
          </p>
        </div>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8'>
          ...
          (dashboardData.recentActivity.documents.length>0 || 
            ...
            .sort((a,b)=>new Date(b.timestamp)-new Date(a.timestamp))  //Agar b bada hai (more recent) → result positive...Positive return → b ko pehle rakho..This sorts in descending order (latest → oldest).
            .map((activity, index) =>(
              <div
