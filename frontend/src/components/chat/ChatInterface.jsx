...
const ChatInterface = () => {
    ...
    const renderMessage=(msg,index)=>{   //hr message ko kaise dikhana hai ye renderMessage() decide karega
       ...
       return (
        <div key={index} className={`flex items-start gap-3 my-4 ${isUser ? 'justify-end': ''}`}>
            ...
            {isUser? (
                ...
                <div className='prose prose-sm max-w-none pross-slate'>
            ...
            {loading && (
               <div className="flex items-center gap-3 my-4">
                <div className='w-9 h-9 rounded-xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-emerald-500/25 flex items-center justify-center shrink-0'>
                    ...
                    <div className='flex items-center gap-2 px-4 px-2 rounded-bl-md bg-white border border-slate-200/60'>
        ...
        <div className='p-5 border-t border-slate-200/60 bg-white/80'>
            <form onSubmit={handleSendMessage} className='flex items-center gap-3'>
                <input
                   ...
                   disabled={loading}  //this inpput block gets disabled when there will be loading
                   />
                   <button
                     type="submit"
