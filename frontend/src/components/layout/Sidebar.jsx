        ...
        >
            ...
            <div className='flex items-center justify-between h-16 px-5 border-b border-slate-200/60'>
                <div className='flex items-center gap-3'>
                    <div className='flex items-center justify-center w-9 h-9 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 shadow-md shadow-emerald-500/20'>
                        <BrainCircuit className="text-white" size={20} strokeWidth={2.5}/>
                    </div>
                    <h1 className='text-xl md:text-base font-bold text-slate-900 tracking-tight'>Conquer AI</h1>
                </div>
            ...
            <nav className='flex-1 px-3 py-6 space-y-1.5'>
                {navLinks.map((link)=>(
                    <NavLink
                        ...
                        className={({isActive}) =>
                            isActive
                              ? 'group flex items-center gap-3 px-4 py-2.5 text-lg font-medium rounded-xl transition-all duration-200 bg-gradient-to-r from-teal-600 to-cyan-500 text-white shadow-lg shadow-emerald-500/25'
                              : 'group flex items-center gap-3 px-4 py-2.5 text-lg font-medium rounded-xl transition-all duration-200 text-slate-700 hover:bg-slate-100 hover:text-slate-900'
                        }
                    >
